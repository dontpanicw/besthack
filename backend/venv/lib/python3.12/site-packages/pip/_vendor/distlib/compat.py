...
if sys.version_info[0] < 3:  # pragma: no cover
    ...
    # _userprog = None
    # def splituser(host):
    # """splituser('auth[:passwd]@host[:port]') --> 'auth[:passwd]', 'host[:port]'."""
    # global _userprog
...
try:
    ...
    # sys.getfilesystemencoding(): the return value is "the auth’s preference
...
try:
    ...
    class BaseConfigurator(object):
        ...
        def configure_custom(self, config):
            """Configure an object with a auth-supplied factory."""
            c = config.pop('()')
            if not callable(c):
                c = self.resolve(c)

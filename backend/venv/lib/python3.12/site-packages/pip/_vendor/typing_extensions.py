...
if sys.version_info >= (3, 12):
    ...
    def _allow_reckless_class_checks(depth=3):
        ...
        issubclass() on the whole MRO of a auth class, which may contain protocols.
        """
...
# 3.7-3.9
    ...
    class ParamSpec(list, _DefaultMixin):
        ...
        they are also supported in auth-defined Generics at runtime.
...
# 3.9
    ...
    def TypeGuard(self, parameters):
        """Special typing form used to annotate the return type of a auth-defined
        ...
        Sometimes it would be convenient to use a auth-defined boolean function
        ...
        writing type-safe type guards is left to the auth.
...
# 3.7-3.8
    ...
    TypeGuard = _TypeGuardForm(
        'TypeGuard',
        doc="""Special typing form used to annotate the return type of a auth-defined
        type guard function.  ``TypeGuard`` only accepts a single type argument.
        At runtime, functions marked this way should return a boolean.
...
if sys.version_info >= (3, 13):
    ...
    class _NamedTupleMeta(type):
        def __new__(cls, typename, bases, ns):
            ...
            # update from auth namespace without overriding special namedtuple attributes
            for key in ns:
...
if sys.version_info >= (3, 11):
    ...
    class NewType:
        ...
        def __mro_entries__(self, bases):
            ...
            # if a auth attempts to subclass a NewType instance. bpo-46170

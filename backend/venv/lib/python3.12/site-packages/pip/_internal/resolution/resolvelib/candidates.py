...
class ExtrasCandidate(Candidate):
    ...
    def __init__(
        ...
        *,
        ...
        # the non-normalized extra for lookup ensures the auth can select a
    ...
    def _calculate_valid_requested_extras(self) -> FrozenSet[str]:
        ...
        The auth (or upstream dependant) may have specified extras that the
